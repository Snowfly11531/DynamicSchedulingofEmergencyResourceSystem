    ...
    public partial class FrmUpstream : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("请选择输出污染发现点上游水系数据", "输出污染发现点上游水系数据", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
                }
                else
                {
                    ...
                    RiverUpstream riverpath = new RiverUpstream();
                    List<IPolyline> listlines = new List<IPolyline>();
                    listlines = riverpath.pollutionpointupstreamriver(pFeatureLayerPollutionpoint, pFeatureLayerRivernetwork);

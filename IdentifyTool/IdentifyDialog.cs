...
namespace IdentifyTool
{
    ...
    public partial class IdentifyDialog : Form
    {
        ...
        private void InitializeActiveViewEvents()
        {
            ...
            /////////////////
            associateMapControl.OnMouseDown += new IMapControlEvents2_Ax_OnMouseDownEventHandler(associateMapControl_OnMouseDown);
            associateMapControl.OnMouseMove += new IMapControlEvents2_Ax_OnMouseMoveEventHandler(associateMapControl_OnMouseMove);
            associateMapControl.OnMouseUp += new IMapControlEvents2_Ax_OnMouseUpEventHandler(associateMapControl_OnMouseUp);
            ///////////////////////
        }
        ///
        ...
        private void associateMapControl_OnMouseDown(object sender, IMapControlEvents2_OnMouseDownEvent e)
        {
            OnMouseDown(e.button, e.mapX, e.mapY);
        }
        private void associateMapControl_OnMouseMove(object sender, ESRI.ArcGIS.Controls.IMapControlEvents2_OnMouseMoveEvent e)
        {
            OnMouseMove(e.mapX, e.mapY);
        }
        private void associateMapControl_OnMouseUp(object sender, IMapControlEvents2_OnMouseUpEvent e)
        {
            OnMouseUp(e.mapX, e.mapY);
        }
        ...
        private IArray Identify(ILayer identifyLayer, IGeometry identifyGeom)
        {
            ...
            if (hitGeometry.GeometryType == esriGeometryType.esriGeometryPoint)
            {
                ...
                hitGeometry = topoOp.Buffer(0.01);
            }
            ///判断图层的类型并作相应处理
            ///图层是要素图层

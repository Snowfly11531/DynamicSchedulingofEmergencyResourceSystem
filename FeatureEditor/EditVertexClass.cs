...
namespace FeatureEditor
{
    internal class EditVertexClass
    {
        ...
        private static void SymbolInit()
        {
            ...
            pFcolor = MapManagement.GetRgbColor(255, 0, 0);
            pOcolor = MapManagement.GetRgbColor(0, 0, 255);
            pTrackcolor = MapManagement.GetRgbColor(0, 255, 255);
            pVcolor = MapManagement.GetRgbColor(0, 255, 0);
            pSColor = MapManagement.GetRgbColor(0, 0, 0);
            //设置各种地图符号的属性
        ...
        public static void ShowAllVertex(IFeatureLayer pFeatLyr)
        {
            ...
            IFeatureCursor pFeatureCursor = MapManagement.GetSelectedFeatures(pFeatLyr);
        ...
        public static IFeature GetSelectedFeature(IFeatureLayer pFeatLyr)
        {
            ...
            IFeature pFeature = null;
            //获取选中的地物
            pFeatureCursor = MapManagement.GetSelectedFeatures(pFeatLyr);
